...
/**
 * @brief Sends a Supervision Frame 
 * 
 * @param fd file descriptor where to write the frame
 * @param addr address to build the trama
 * @param ctrl control byte to send in the trama
 * @return u_int8_t BCC2
 */
int sendSupervisionFrame(int fd, u_int8_t addr, u_int8_t ctrl);

/**
 * @brief Receives the state, the file descriptor, address byte, control byte and a buffer.
